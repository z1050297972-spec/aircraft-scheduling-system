...
import { Plane, ChevronRight, User, LogOut, X, LucideIcon } from 'lucide-react';
        ...
        <div className="p-6 pb-2">
          <div className="flex justify-between items-start mb-8">
            <div className="flex items-center space-x-3 text-blue-700">
              ...
              <div>
                <h1 className="font-bold text-lg tracking-tight text-slate-800 leading-tight">测试用例生成系统</h1>
                <p className="text-[9px] text-slate-400 font-mono tracking-[0.2em] uppercase">Testcase Generator</p>
              </div>
            </div>
